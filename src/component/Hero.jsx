const Hero = () => {
    return (
        <div className="hero min-h-[60vh] md:min-h-[calc(80vh-4rem)] bg-white">
            <div className="relative isolate px-6 pt-14 lg:px-8">
                ...
                <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
                    ...
                    <div className="text-center">
                        <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-7xl leading-tight sm:leading-[1.1] break-keep">
                            풀스택 개발자<br />마준범 입니다.<br />
                            풀스택 개발자<br />마준범 입니다.<br />

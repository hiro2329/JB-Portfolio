const Skills = () => {
    return (
        <div>
            ...
            <section className="w-full flex items-center ">
                <div className="max-w-7xl mx-auto px-4 py-8 w-full">
                    <div className="text-center mb-8">
                        <h2 className="text-3xl font-bold text-gray-900 sm:text-5xl md:text-6xl mb-4">SKILLS</h2>
                    </div>
            ...
            {/* 배경효과 */}
            <div className="absolute inset-x-0 bottom-[calc(100%-13rem)] -z-10 transform-gpu overflow-hidden blur-3xl sm:bottom-[calc(100%-30rem)] rotate-180" aria-hidden="true">
                <div
